...
def predict_endpoint():
    ...
    received_wind_speed_avg = float(request.args.get('Ws1_avg'))
    ...
    prepared_features_df = prepare_features(data=received_data_df, training_mode=False)

    prediction_dict = predict(features=prepared_features_df, model_path=MODEL_PATH).to_dict()
